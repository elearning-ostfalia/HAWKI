# Guidelines for Using OLAF

Welcome to the guidelines for using OLAF, which provides language models from OpenAI, Google, and open-source models via GWDG.  
...
- Ostfalia has a data processing agreement with GWDG, ensuring that GWDG does not store data sent via OLAF.  
...
- Abusive or discriminatory behavior may result in exclusion from OLAF.  
...
- Further details are available in the OLAF privacy policy.  
...
- Students may use OLAF for learning support but must not rely solely on generated responses.  
- Entering personal data (own or others’) is strictly prohibited.  
- Students remain responsible for outputs created with OLAF and must disclose the use of AI transparently.  
...
- OLAF may be used for efficiency and daily work support, provided that data protection and security policies are followed.  

---

## Final Notes

These guidelines are intended as orientation for the responsible use of OLAF.  
